...
{
    internal class HasingService
    {
        private int NodeId;
        private List<P2PStorage.Service.Services.Node.Node> ConnectedNodes;
        private List<ValueTable> _valueTable;
        private NodeRoleEnum NodeRole;
        private int noOfReceiverNodes;

        public HasingService(int nodeId, List<P2PStorage.Service.Services.Node.Node> connectedNodes, List<ValueTable> valueTable, NodeRoleEnum role) 
        {
            this.NodeId = nodeId;
